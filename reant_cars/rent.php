...
<!--                                    <label style="color: white" for="location_1">PICK-UP LOCATION</label>-->
<!--                                    <select name="location" id="location_1" class="form-control">-->
...
<!--                                </div>-->
<!--                                <div class="col-12 col-md-6 col-lg-3">-->
<!--                                    <label style="color: white" for="location_2">DROP-OFF LOCATION</label>-->
<!--                                    <select name="location" id="location_2"  class="form-control">-->
<!--                                        <option value="location">Location</option>-->
<!--                                        <option value="armenia">Armenia</option>-->
<!--                                        <option value="argentina">Argentina</option>-->
<!--                                        <option value="australia">Australia</option>-->
...
<!--                                        <div class="picker_1"> </div>-->
<!--                                        <input type="hidden" name="date_start" id="result" value="" />-->
<!--                                </div>-->
<!--                                <div class="col-12 col-md-6 col-lg-3">-->
<!--                                    <label style="color: white" >DROP-OFF DATE</label>-->
<!--                                    <div class="picker_2"> </div>-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-content-two">
                    ...
                    <h2 class="page-title">For Rent</h2>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $.getJSON('http://localhost:8080/locations', function (data) {
        window.eqfeed_callback = function(results) {
            var infoWin = new google.maps.InfoWindow();
            var markers = data.map(function (locations, i) {
                ...
                google.maps.event.addListener(marker, 'click', function (evt) {
                    console.log(2);
                    infoWin.setContent(coords.info);
                    infoWin.open(map, marker);
                })
                return marker;
            });
            // let markers= for (var i = 0; i < data.length; i++) {
            //      var coords = data[i];
            //      console.log(coords);
            //      var latLng = new google.maps.LatLng(coords.lat,coords.lng);
            //      var marker = new google.maps.Marker({
...
<script type="text/javascript">
        $.getJSON('http://localhost:8080/v1/cars', function (data) {
            ...
            <a  class="badge-rent" href="/reant_cars/properties-details.php?id=${e.car_id}">Rent</a>
